...
function remove_wpfp_before_link_img() {
    return "<img src='".WPFP_PATH."/img/icon_coffee.png' alt='remove' title='remove' class='wpfp-img' />";
}
...
function wpfp_init() {
    ...
    $wpfp_options['cookie_warning'] = "Your favorite pets are saved to your browsers cookies. If you clear cookies, your favorite pets will be deleted.";
