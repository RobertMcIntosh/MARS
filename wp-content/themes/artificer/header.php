		...
		<?php woo_nav_before(); ?>
			<hgroup>
				...
				if ( isset( $woo_options['woo_logo'] ) && $woo_options['woo_logo'] != '' ) {
					...
					if ( isset( $woo_options['woo_logo'] ) && $woo_options['woo_logo'] != '' && is_ssl() ) {
				...
				<a id="logo" href="<?php bloginfo( 'url' ); ?>"
					...
					src="<?php echo $logo; ?>" alt="<?php bloginfo( 'name' ); ?>" />
				</a>
				<?php } ?>
				
				<h1
					class="site-title <?php if ( $woo_options['woo_texttitle'] == 'true' ) { echo 'visible'; } ?>">
					<a href="<?php bloginfo( 'url' ); ?>"><?php bloginfo( 'name' ); ?>
					</a>
				</h1>
				<p
					class="site-description <?php if ( $woo_options['woo_tagline'] == 'true' ) { echo 'visible'; } ?>">
			...
			<div id="topad">
				...
				if ( isset( $woo_options['woo_ad_top_adsense'] ) && $woo_options['woo_ad_top_adsense'] != '' ) {
					...
					if ( isset( $woo_options['woo_ad_top_url'] ) && isset( $woo_options['woo_ad_top_image'] ) )
						?>
				<a href="<?php echo $woo_options['woo_ad_top_url']; ?>"><img
					src="<?php echo $woo_options['woo_ad_top_image']; ?>" width="468"
					height="60" alt="advert" /> </a>
				<?php } ?>
			</div>
			<!-- /#topad -->
			<?php } ?>
			...
			<h3 class="nav-toggle">
				<a href="#navigation"><?php _e('Main navigation', 'woothemes'); ?> </a>
			</h3>
			...
			?>
				<ul id="main-nav" class="nav fl">
					...
					<li class="<?php echo $highlight; ?>"><a
						href="<?php echo home_url( '/' ); ?>"><?php _e( 'Home', 'woothemes' ); ?>
					</a></li>
