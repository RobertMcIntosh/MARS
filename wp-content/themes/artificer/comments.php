...
<div id="comments">
	...
	<?php if ( ! empty( $comments_by_type['comment'] ) ) { ?>
		<h3><?php comments_number( __( 'No Responses', 'woothemes' ), __( 'One Response', 'woothemes' ), __( '% Responses', 'woothemes' ) ); ?> 
		<?php _e( 'to', 'woothemes' ); ?> &#8220.<?php the_title(); ?>&#8221;</h3>
...
<?php 
	...
	$output .= wp_list_comments( 'avatar_size=60&callback=custom_comment&type=comment' );
...
?>	 
	...
	<?php echo  do_shortcode('[expand id="expandClose" title="Expand" swaptitle="Close" swapalt="Close" style="display: block;"]'
	.$output.'<span class="collapseomatic colomat-close scroll-to-trigger" id="bot-expandClose">click here to close</span>[/expand]');?>
